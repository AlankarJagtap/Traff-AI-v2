          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <Link to="/" className="flex items-center group">
                <span className="text-3xl font-black text-slate-900 group-hover:text-primary-700 transition-colors">🚗 Traff-AI</span>
              </Link>
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 border-t border-gray-700 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-white font-bold text-lg mb-4">Traff-AI</h3>
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © 2025 Traff-AI. Built with ❤️ using FastAPI + React + YOLOv11
            </p>
          </div>
        </div>
      </footer>
